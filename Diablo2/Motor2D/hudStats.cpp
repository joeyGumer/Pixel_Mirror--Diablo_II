...
bool hudStats::Start()
{
	...
	player_name = App->gui->AddGuiLabel("Name", NULL, { 0, 2 }, name, FONT_WHITE, this);
	player_name->Center(true, false);
	...
	player_experience = App->gui->AddGuiLabel("7", NULL, { 0, 2 }, experience, FONT_WHITE, this);
	...
	player_vitality_name = App->gui->AddGuiLabel("Vitality", App->font->description, { 0, 2 }, vitality, FONT_WHITE, this);
	vitality_value = App->gui->AddGuiImage({ 76, 82 }, { 779, 960, 40, 20 }, window, this);
	text.create("%i", App->game->player->life);
	player_vitality = App->gui->AddGuiLabel(text, App->font->description, { 0, 2 }, vitality_value, FONT_BLUE, this);
	player_vitality->Center(true, false);
	...
	player_strength_name = App->gui->AddGuiLabel("Strength", App->font->description, { 0, 2 }, strength, FONT_WHITE, this);
	strength_value = App->gui->AddGuiImage({ 76, 136 }, { 779, 960, 40, 20 }, window, this);
	player_strength = App->gui->AddGuiLabel(text, App->font->description, { 0, 2 }, strength_value, FONT_BLUE, this);
	player_strength->Center(true, false);
	...
	player_dexterity_name = App->gui->AddGuiLabel("Dexterity", App->font->description, { 0, 2 }, dexterity, FONT_WHITE, this);
	dexterity_value = App->gui->AddGuiImage({ 76, 190 }, { 779, 960, 40, 20 }, window, this);
	text.create("%i", App->game->player->bonus_martial_damage);
	player_dexterity = App->gui->AddGuiLabel(text, App->font->description, { 0, 2 }, dexterity_value, FONT_BLUE, this);
	player_dexterity->Center(true, false); 
	...
	player_intelligence_name = App->gui->AddGuiLabel("Intelligence", App->font->description, { 0, 2 }, intelligence, FONT_WHITE, this);
	intelligence_value = App->gui->AddGuiImage({ 76, 242 }, { 779, 960, 40, 20 }, window, this);
	text.create("%i", App->game->player->bonus_spell_damage);
	player_intelligence = App->gui->AddGuiLabel(text, App->font->description, { 0, 2 }, intelligence_value, FONT_BLUE, this);
	player_intelligence->Center(true, false);
	...
	player_luck_name = App->gui->AddGuiLabel("Luck", App->font->description, { 0, 2 }, luck, FONT_WHITE, this);
	luck_value = App->gui->AddGuiImage({ 76, 296 }, { 779, 960, 40, 20 }, window, this);
	text.create("%i", App->game->player->drop);
	player_luck = App->gui->AddGuiLabel(text, App->font->description, { 0, 2 }, luck_value, FONT_BLUE, this);
	player_luck->Center(true, false);
	...
	life_name = App->gui->AddGuiLabel("Life", App->font->description, { 0, 2 }, life, FONT_WHITE, this);
	life_1 = App->gui->AddGuiImage({ 230, 82 }, { 779, 960, 40, 20 }, window, this);
	text.create("%i", App->game->player->HP_current);
	current_life = App->gui->AddGuiLabel(text, App->font->description, { 0, 2 }, life_1, FONT_WHITE, this);
	current_life->Center(true, false);

	life_2 = App->gui->AddGuiImage({ 272, 82 }, { 779, 960, 40, 20 }, window, this);
	text.create("%i", App->game->player->HP_max);
	life_max = App->gui->AddGuiLabel(text, App->font->description, { 0, 2 }, life_2, FONT_WHITE, this);
	life_max->Center(true, false);
	...
	stamina_name = App->gui->AddGuiLabel("STamina", App->font->description, { 0, 2 }, stamina, FONT_WHITE, this);
	stamina_1 = App->gui->AddGuiImage({ 230, 108 }, { 779, 960, 40, 20 }, window, this);
	text.create("%i", App->game->player->ST_current);
	current_stamina = App->gui->AddGuiLabel(text, App->font->description, { 0, 2 }, stamina_1, FONT_WHITE, this);
	current_stamina->Center(true, false);
	stamina_2 = App->gui->AddGuiImage({ 272, 108 }, { 779, 960, 40, 20 }, window, this);
	text.create("%i", App->game->player->ST_max);
	stamina_max = App->gui->AddGuiLabel(text, App->font->description, { 0, 2 }, stamina_2, FONT_WHITE, this);
	stamina_max->Center(true, false);
	...
	basicAttack_name = App->gui->AddGuiLabel("Basic Attack", App->font->description, { 5, 2 }, basicAttack, FONT_WHITE, this);
	basicAttack_value = App->gui->AddGuiImage({ 260, 136 }, { 779, 960, 48, 20 }, window, this);
	text.create("%i", App->game->player->basic_damage);
	player_basicAttack = App->gui->AddGuiLabel(text, App->font->description, { 0, 2 }, basicAttack_value, FONT_WHITE, this);
	player_basicAttack->Center(true, false);
	...
	resistance_name = App->gui->AddGuiLabel("Resistance", App->font->description, { 5, 2 }, resistance, FONT_WHITE, this);
	resistance_value = App->gui->AddGuiImage({ 272, 396 }, { 779, 960, 48, 20 }, window, this);
	text.create("%i", App->game->player->basic_damage);
	player_resistance = App->gui->AddGuiLabel(text, App->font->description, { 0, 2 }, resistance_value, FONT_WHITE, this);
	player_resistance->Center(true, false);
